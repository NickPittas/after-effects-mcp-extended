...
server.tool(
  "after-effects",
  "General After Effects control surface. Use one operation with structured parameters for inspection, properties, keyframes, effects, masks, shape contents, layers, compositions, projects, or frame capture.",
  {
    operation: z.enum([
      "inspect",
      "property",
